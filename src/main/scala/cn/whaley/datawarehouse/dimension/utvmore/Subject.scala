...
/**
  * Created by zhu.bingxin on 20190507.
  *
  * 优视猫_节目专题维度表
  */
object Subject extends DimensionBase {

  dimensionName = "dim_utvmore_subject"
  ...
  sourceDb = MysqlDB.utvmoreGeminiTvservice("mtv_subject", "ID", 1, 4000, 5)
  ...
  override def filterSource(sourceDf: DataFrame): DataFrame = {
    ...
    sourceDf.filter($"code".isNotNull && $"code".notEqual("")
      ...
      .select(
        ...
        $"s.content_type".as("subject_content_type"),
